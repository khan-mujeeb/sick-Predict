...
public class UpdateEmailActivity extends AppCompat {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextPwd = findViewById(R.id.current_email_password);
        editTextNewEmail = findViewById(R.id.updated_email);
        ...
        TextView textViewOldEmail = findViewById(R.id.current_email);
    ...
    private void reAuthenticate(FirebaseUser firebaseUser) {
        Button buttonVerifyUser = findViewById(R.id.button_authentic_email);
                    ...
                    firebaseUser.reauthenticate(credential).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(UpdateEmailActivity.this, "Password has been verified! Update email now.", Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.menu_refresh){
            ...
            Intent intent = new Intent(UpdateEmailActivity.this,EditProfileActivity.class);
            startActivity(intent);
            finish();
